(() => {
  ...
  function j(n2, u3, i3, t3, o3, r3, f3, e3, c3) {
    var s2, h2, v3, y2, p2, k2, b3, m3, g3, x3, A, P2 = u3.type;
    ...
    try {
      n:
        if (typeof P2 == "function") {
          ...
          h2.context = x3, h2.props = m3, h2.state = h2.__s, (s2 = l.__r) && s2(u3), h2.__d = false, h2.__v = u3, h2.__P = n2, s2 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s, h2.getChildContext != null && (t3 = a(a({}, t3), h2.getChildContext())), v3 || h2.getSnapshotBeforeUpdate == null || (k2 = h2.getSnapshotBeforeUpdate(y2, p2)), A = s2 != null && s2.type === d && s2.key == null ? s2.props.children : s2, w(n2, Array.isArray(A) ? A : [A], u3, i3, t3, o3, r3, f3, e3, c3), h2.base = u3.__e, u3.__h = null, h2.__h.length && f3.push(h2), b3 && (h2.__E = h2.__ = null), h2.__e = false;
        } else
  ...
  function L(l3, u3, i3, t3, o3, r3, f3, c3) {
    var s2, a3, v3, y2 = i3.props, p2 = u3.props, d2 = u3.type, _2 = 0;
    ...
    if (d2 === null)
      ...
      if (C(l3, p2, y2, o3, c3), v3)
        ...
        for (_2 = r3.length; _2--; )
          r3[_2] != null && h(r3[_2]);
      c3 || ("value" in p2 && (_2 = p2.value) !== void 0 && (_2 !== l3.value || d2 === "progress" && !_2 || d2 === "option" && _2 !== y2.value) && H(l3, "value", _2, y2.value, false), "checked" in p2 && (_2 = p2.checked) !== void 0 && _2 !== l3.checked && H(l3, "checked", _2, y2.checked, false));
    }
    return l3;
  }
  function M(n2, u3, i3) {
  ...
  // search/src/components/input.jsx
  function Input() {
    const [results, setResults] = m2([]);
    const search = (e3) => {
      fetch("/search?lib=1&query=" + e3.target.value).then((resp) => resp.json()).then((json) => {
        setResults(json.query.length);
      }).catch((err) => {
      });
    };
    return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("input", {
      type: "text",
      placeholder: "Search",
      className: "block bg-gray-100 w-full p-4",
      onKeyUp: search
    }), /* @__PURE__ */ v("div", null, results));
  }
  ...
  function Layout() {
    return /* @__PURE__ */ v("div", {
      class: ""
    }, /* @__PURE__ */ v(input_default, null));
  }
  S(/* @__PURE__ */ v(Layout, null), document.body);
})();
